  ...
  const MintBlogger = {
    ...
    comments: {
      ...
      handleComments: function() {
        const originalForm = this.form.innerHTML;
        const {originalSrc, form} = this.extractFormSrc(originalForm);
        ...
        this.replyButtons?.forEach(btn => {
          btn.onclick = () => {
            ...
            if (existingReplyForm) {
              existingReplyForm.parentElement.classList.remove("has-reply-form");
              existingReplyForm.remove();
            } else {
              this.form.innerHTML = "";
              this.formRestore.classList.add("is-replying");
            }
            ...
            const {form: newForm} = this.extractFormSrc(originalForm, newSrc);
        ...
        this.formRestore?.onclick = () => {
          if (activeBtn) {
            ...
            this.formRestore.classList.remove("is-replying");
            this.form.innerHTML = form;
            activeBtn.classList.remove("is-active");
            activeBtn = null;
            replyForm.parentElement.classList.remove("has-reply-form");
            replyForm.remove();
          }
        };
      }
